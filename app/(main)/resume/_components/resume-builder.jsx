...
const ResumeBuilder = ({ initialContent }) => {
  ...
  useEffect(() => {
    import("html2pdf.js").then((module) =>
      setPdfGenerator(() => module.default)
    );
  }, []);
  ...
  const getContactMarkdown = () => {
    ...
    if (contactInfo.twitter) parts.push(`👾 [Github](${contactInfo.github})`);
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      await pdfGenerator().set(options).from(element).save();
    } catch (error) {
